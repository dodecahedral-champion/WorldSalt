namespace WorldSalt.UnitTests.Network.Payloads.Ping {
	...
	[TestFixture]
	public class ClientPingPayloadUnitTest {
		private ClientPingPayload target;

		[SetUp]
		public void Setup() {
			target = new ClientPingPayload();
		}

		[Test]
		public void ShouldConstructWithDefaults() {
			var localTarget = new ClientPingPayload();
		...
		public void ShouldGetBytes() {
			...
			var localTarget = new ClientPingPayload(guid);
